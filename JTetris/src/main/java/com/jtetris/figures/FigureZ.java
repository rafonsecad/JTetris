 ...
 * @author rafael
 */
public class FigureZ extends FigureBase implements Figure{
    
    public FigureZ(){
        
        List<Rectangle> components = new ArrayList<>();

        components.add(new Rectangle(120, 0, 19.75, 19.75));
        components.add(new Rectangle(140, 0, 19.75, 19.75));
        components.add(new Rectangle(140, 20, 19.75, 19.75));
        components.add(new Rectangle(160, 20, 19.75, 19.75));
